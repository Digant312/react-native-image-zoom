...
var ImageViewer = /** @class */ (function (_super) {
  ...
  function ImageViewer() {
    ...
    // 缩放大小
    _this.scale = _this.props.initialScale || 1;
    ...
    _this.panResponderReleaseResolve = function () {
      ...
      if (_this.props.imageWidth * _this.scale <= _this.props.cropWidth) {
        // 如果图片宽度小于盒子宽度，横向位置重置
        _this.positionX = _this.props.initX || 0;
      ...
      if (_this.props.imageHeight * _this.scale <= _this.props.cropHeight) {
        // 如果图片高度小于盒子高度，纵向位置重置
        _this.positionY = _this.props.initY || 0;
  ...
  ImageViewer.prototype.centerOn = function (params) {
    var _this = this;
    this.positionX = _this.props.initX || params.x;
    this.positionY = _this.props.initY || params.y;
    this.scale = _this.props.initialScale || params.scale;
